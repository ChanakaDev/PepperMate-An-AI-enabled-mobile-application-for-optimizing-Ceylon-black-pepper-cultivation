# -*- coding: utf-8 -*-
"""R-07 ✅ 4. Multivariate (LSTM).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hE_uGq1BHCVRVl_UyLKDRmBderjaAWng
...
national_df = pd.read_csv('/content/drive/MyDrive/pepper_mate_models/price_prediction_models/all_ml_models/national_df_multivariate_models/dataset/dollar_combined_dataset.csv')
...
# Extract relevant features for the multivariate model
features = national_df[['gr1_high_price', 'gr1_avg_price', 'gr2_high_price', 'gr2_avg_price', 'white_high_price', 'white_avg_price', 'dollar_rate']]
...
model = tf.keras.models.Sequential([
        tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(lstm_units, return_sequences=True, input_shape=(window_size, 7))),
...
history = model.fit(
    windowed_training_dataset,
    epochs=500,
    validation_data=windowed_validation_dataset,
...
model.save('/content/drive/MyDrive/pepper_mate_models/price_prediction_models/all_ml_models/national_df_multivariate_models/saved_models/r_067_lstm.keras')

model.save('/content/drive/MyDrive/pepper_mate_models/price_prediction_models/all_ml_models/national_df_multivariate_models/saved_models/r_07_lstm.h5')